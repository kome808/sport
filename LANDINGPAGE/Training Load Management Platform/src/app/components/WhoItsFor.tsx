...
export function WhoItsFor({ images, onGuideClick }: WhoItsForProps) {
  return (
          ...
          <div className="group relative bg-zinc-900 border-2 border-white/10 hover:border-[#c1ff00] overflow-hidden transition-all duration-300">
            ...
            <div className="p-8 lg:p-12">
              ...
              <button 
                ...
                className="group inline-flex items-center gap-3 text-[#c1ff00] font-black uppercase tracking-widest text-lg hover:gap-5 transition-all"
              >
                關於運動訓練負荷管理
