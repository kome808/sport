...
export function Header({ onGuideClick, onHomeClick }: HeaderProps) {
  return (
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex items-center gap-3 lg:gap-6">
            <button 
              ...
              className="hidden md:block text-gray-400 hover:text-[#c1ff00] font-bold text-sm uppercase tracking-wider transition-colors"
            >
              科學指南
            </button>
