...
import { Activity, Heart, Brain, TrendingUp, TrendingDown, ClipboardCheck, Info, BookOpen, AlertCircle } from "lucide-react";
import { Button } from "@/components/ui/button";
import { ImageWithFallback } from "@/components/ui/ImageWithFallback";
import { Header } from "@/components/landing/Header";
import { Footer } from "@/components/landing/Footer";

// Exact images from Figma reference
const images = {
    acwr: "https://images.unsplash.com/photo-1730251446354-bc3570752717?q=80&w=1080",
    rhr: "https://images.unsplash.com/photo-1682706841289-9d7ddf5eb999?q=80&w=1080",
    ...
    srpe: "https://images.unsplash.com/photo-1626337920103-ae64b9c688e4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzcG9ydCUyMGF0aGxldGUlMjByZXN0aW5nJTIwc2l0dGluZyUyMGJsYWNrJTIwYmFja2dyb3VuZHxlbnwxfHx8fDE3Njk1NzE5NjF8MA&ixlib=rb-4.1.0&q=80&w=1080"
};
...
export default function ScienceGuidePage() {
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-black text-white font-sans selection:bg-[#c1ff00] selection:text-black">
            <Header />
            ...
            <main className="container mx-auto px-4 lg:px-8 max-w-6xl relative z-10 pt-32 pb-20">
                <motion.div
                        ...
                        <div className="flex flex-col lg:flex-row gap-16 items-start">
                            <div className="flex-1">
                                ...
                                <div className="space-y-8">
                                    <div>
                                        ...
                                        <ul className="space-y-4">
                                            <li className="flex items-start gap-3">
                                                <div className="w-2 h-2 rounded-full bg-[#c1ff00] mt-2.5 flex-shrink-0"></div>
                                    ...
                                    <div className="grid grid-cols-1 gap-4 pt-4">
                                        <div className="flex items-center gap-6 p-5 bg-white/5 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors duration-300">
                            ...
                            <div className="w-full lg:w-2/5 lg:sticky lg:top-32">
                                <div className="relative group">
                                    ...
                                    <ImageWithFallback
                                        src={images.acwr}
                                        alt="Athlete training data visualization"
                    ...
                    <section className="mb-32">
                        <div className="flex flex-col lg:flex-row-reverse gap-16 items-start">
                            ...
                            <div className="w-full lg:w-2/5 lg:sticky lg:top-32">
                                <ImageWithFallback
                                    src={images.rhr}
                                    alt="Smart watch measuring heart rate"
                                    className="rounded-3xl border border-white/10 w-full aspect-square object-cover shadow-2xl"
                                />
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-32">
                        <div className="flex flex-col lg:flex-row gap-16 items-start">
                            <div className="flex-1">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="flex gap-4 pt-4">
                                        <div className="flex-1 bg-green-500/10 border border-green-500/20 p-6 rounded-2xl text-center hover:bg-green-500/15 transition-colors">
                                        ...
                                        <div className="flex-1 bg-red-500/10 border border-red-500/20 p-6 rounded-2xl text-center hover:bg-red-500/15 transition-colors">
                            ...
                            <div className="w-full lg:w-2/5 lg:sticky lg:top-32">
                                <ImageWithFallback
                                    src={images.wellness}
                                    alt="Athlete sleeping for recovery"
                                    className="rounded-3xl border border-white/10 w-full aspect-video lg:aspect-square object-cover shadow-2xl"
                                />
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="flex flex-col lg:flex-row-reverse gap-16 items-start">
                            <div className="flex-1">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <a href="/register">
                                        <Button
                                            className="w-full bg-[#c1ff00] hover:bg-[#d4ff33] text-black font-black py-8 text-xl uppercase tracking-widest rounded-xl shadow-[0_10px_30px_rgba(193,255,0,0.2)] hover:shadow-[0_20px_40px_rgba(193,255,0,0.3)] hover:scale-[1.02] transition-all duration-300"
                                        >
                                            立刻開始科學化管理 →
                                        </Button>
                                    </a>
                            ...
                            <div className="w-full lg:w-2/5 lg:sticky lg:top-32">
                                <ImageWithFallback
                                    src={images.srpe}
                                    alt="Coach clipping on session RPE data"
